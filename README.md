...
echo "Gateway token saved to: ~/.openclaw/gateway-token.txt"
...
# Отредактируйте .env и установите GATEWAY_TOKEN из ~/.openclaw/gateway-token.txt
...
# Токен из поля gateway.auth.token в ~/.openclaw/openclaw.json
