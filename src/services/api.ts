...
export const agentsApi = {
  ...
  getTools: (id: number) => api.get(`/agents/${id}/tools`),
  updateTools: (id: number, toolIds: number[]) => api.post(`/agents/${id}/tools`, { toolIds }),
  removeTool: (id: number, toolId: number) => api.delete(`/agents/${id}/tools/${toolId}`),
}
...
export const toolsApi = {
  list: (params?: { source?: string }) => api.get('/tools', { params }),
